...
/// to expand.
///
/// [NestedScrollView3M] solves this problem by providing custom
...
///
/// {@tool dartpad}
/// This example shows a [NestedScrollView3M] whose header is the combination of a
...
/// {@end-tool}
///
/// ## [SliverAppBar]s with [NestedScrollView3M]s
///
/// Using a [SliverAppBar] in the outer scroll view, or [headerSliverBuilder],
/// of a [NestedScrollView3M] may require special configurations in order to work
/// as it would if the outer and inner were one single scroll view, like a
/// [CustomScrollView].
///
/// ### Pinned [SliverAppBar]s
///
/// A pinned [SliverAppBar] works in a [NestedScrollView3M] exactly as it would in
...
///
/// This works naturally in a [NestedScrollView3M], as the pinned [SliverAppBar]
...
///
/// In order to float the outer, use [NestedScrollView3M.floatHeaderSlivers]. When
...
///
/// {@tool dartpad}
/// This simple example shows a [NestedScrollView3M] whose header contains a
...
///
/// It is possible with a [NestedScrollView3M] to perform just the snapping
/// animation without floating the app bar in and out. By not using the
/// [NestedScrollView3M.floatHeaderSlivers], the app bar will snap in and out
/// without floating.
///
...
/// implemented in a [NestedScrollView3M]. These widgets take any overlapping
...
/// e.g [NestedScrollView3M.floatHeaderSlivers], the [SliverAppBar] will animate
...
/// Currently, [NestedScrollView3M] does not support simultaneously floating and
...
/// Currently, [NestedScrollView3M] does not support stretching the outer
...
class NestedScrollView3M extends StatefulWidget {
  ...
  /// The widget to show inside the [NestedScrollView3M].
  ///
  /// Typically this will be [TabBarView].
  ///
  /// The [body] is built in a context that provides a [PrimaryScrollController]
  /// that interacts with the [NestedScrollView3M]'s scroll controller. Any
  /// [ListView] or other [Scrollable]-based widget inside the [body] that is
  /// intended to scroll with the [NestedScrollView3M] should therefore not be
  /// given an explicit [ScrollController], instead allowing it to default to
  /// the [PrimaryScrollController] provided by the [NestedScrollView3M].
  final Widget body;

  /// {@macro flutter.widgets.scrollable.dragStartBehavior}
  final DragStartBehavior dragStartBehavior;

  /// Whether or not the [NestedScrollView3M]'s coordinator should prioritize the
  ...
  ///
  /// For sample code showing how to use this method, see the [NestedScrollView3M]
  /// documentation.
  ...
  @override
  NestedScrollView3MState createState() => NestedScrollView3MState();
}

/// The [State] for a [NestedScrollView3M].
///
/// The [ScrollController]s, [innerController] and [outerController], of the
/// [NestedScrollView3M]'s children may be accessed through its state. This is
/// useful for obtaining respective scroll positions in the [NestedScrollView3M].
///
/// If you want to access the inner or outer scroll controller of a
/// [NestedScrollView3M], you can get its [NestedScrollView3MState] by supplying a
/// `GlobalKey<NestedScrollViewState>` to the [NestedScrollView3M.key] parameter).
///
/// {@tool dartpad}
/// [NestedScrollView3MState] can be obtained using a [GlobalKey].
...
class NestedScrollView3MState extends State<NestedScrollView3M> {
  ...
  ///    sliver(s) contained in [NestedScrollView3M.headerSliverBuilder].
  ScrollController get innerController => _coordinator!._innerController;

  /// The [ScrollController] provided to the [ScrollView] in
  /// [NestedScrollView3M.headerSliverBuilder].
  ///
  /// This is equivalent to [NestedScrollView3M.controller], if provided.
  ///
  ...
  ///    [ScrollView] contained in [NestedScrollView3M.body].
  ...
  @override
  void didUpdateWidget(NestedScrollView3M oldWidget) {
...
class _InheritedNestedScrollView extends InheritedWidget {
  ...
  final NestedScrollView3MState state;
...
class _NestedScrollCoordinator
  ...
  final NestedScrollView3MState _state;
